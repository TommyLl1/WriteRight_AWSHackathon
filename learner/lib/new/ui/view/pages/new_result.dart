...
Future<void> updateTaskAndStatus(BuildContext context) async {
  try {
    final taskRepository = context.read<TaskRepository>();
    final userRepository = context.read<UserRepository>();

    // Increment daily adventure task progress using repository method
    await taskRepository.incrementDailyAdventureTaskProgress();

    // fetch and update user status/profile
    await userRepository.fetchUserStatus();
  } catch (e, stack) {
    // Log error but don't block navigation
    debugPrint('Error updating task and status: $e\n$stack');
  }
}
